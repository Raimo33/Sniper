...
/*   Updated: 2025/02/05 21:56:38 by craimond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
HOT void handle_rest_connection(const uint8_t fd, const uint32_t events, void *data);
HOT void handle_rest_setup(const uint8_t fd, const uint32_t events, void *data);
HOT void handle_rest_trading(const uint8_t fd, const uint32_t events, void *data);
