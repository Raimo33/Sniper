...
/*   Updated: 2025/01/18 10:00:30 by craimond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void COLD init_keys(keys_t *keys);
void COLD generate_ws_keys(byte[WS_KEY_SIZE] ws_key);
void COLD free_keys(keys_t *keys);
