...
/*   Updated: 2025/01/27 14:21:13 by craimond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline void free_keys_wrapper(void)         { free_keys(&app->keys); }
static inline void free_ssl_wrapper(void)          { free_ssl(app->ssl_ctx); }
static inline void free_fix_wrapper(void)          { free_fix(&app->fix_client); }
static inline void free_ws_wrapper(void)           { free_ws(&app->ws_client); }
